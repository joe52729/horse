<?php
    ...
    <div class="d-flex">
        ...
        <div class="main-panel" id="seed-container">
            ...
            <ol class="breadcrumb breadcrumb-arrow">
                    ...
                    <li class="breadcrumb-item">
                        <a href="<?= site_url('admin/weight_set'); ?>">
                            <?= $this->lang->line('left_weight_set'); ?>
                        <a>                    
                    </li>
                </ol>                
                <h3 class="mb-4"><?= $this->lang->line('weight_add'); ?></h3>
                <div class="card">
                    <div class="card-body">
                                    ...
                                    <div class="body">
                                        <form role="form" name="" id="form">
                                            ...
                                            <div class="row clearfix">
                                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                    <div class="form-group" style="line-height:34px">
                                                        <label class="active" for="weight_add_title">
                                                            <?=$this->lang->line('weight_add_title');?>
                                                        </label>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row clearfix">
                                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                                    <div class="form-group" style="line-height:34px">
                                                        <label class="active" for="weight_add_g">
                                                            <?=$this->lang->line('weight_add_g');?>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                    <div class="form-group">
                                                        <input type="number"  class="form-control" placeholder=""  name="weight" value="<?=$data->weight?>" required>
	...
	<script type="text/javascript">
		function save() {
			var url;
			url = "<?php echo base_url('admin/weight_update/update') ?>";
			$.post(url, $('#form').serialize(), function(response) {
				if (response.status == 'T') {
					swal('<?=$this->lang->line('sys_update_ss'); ?>');
					// location.reload();
					window.location.assign("<?php echo base_url('admin/weight_set') ?>");
					return false;
				} else {
					swal(response.msg);
					return false;
