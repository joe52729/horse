    ...
    <div class="main-panel" id="seed-container">
        <div class="content-wrapper">
            <div class="card">
                ...
                <button type="button" onclick="change()" class="btn btn-success">變更密碼</button>	
		        </body>  
                </div>
            </div>
            <?php 
...
<script type="text/javascript">
    ...
    function user_home() {
        var url = "<?php echo base_url('index/home');?>";
       
        
        $.post(url, $('#change').serialize(), function(response) {//response是變數名稱可以改變
